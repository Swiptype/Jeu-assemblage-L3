...
/**
 * Classe représentant une pièce de puzzle de type "U".
 * Cette pièce est carrée et peut être orientée à 0°, 90°, 180° et 270°.
 */
public class UPiece extends AbstractPiecePuzzle {

    /**
     * Constructeur de la classe UPiece.
     *
     * @param hauteur La hauteur de la pièce de type "U".
     * @param largeur La largeur de la pièce de type "U".
     */
    public UPiece(int hauteur, int largeur) {
